...
export const getPreferredPersonality = async (): Promise<Personality | undefined> => {
  const data = await getStorageData();
  return data.preferredPersonality;
};

export const setPreferredPersonality = async (personality: Personality): Promise<void> => {
